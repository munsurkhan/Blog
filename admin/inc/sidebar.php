                ...
                <div class="nav">
                    ...
                    <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link" href="titleslogan.php">Title & Slogan</a>
                            <a class="nav-link" href="socialmedia.php">Social Media</a>
                            <a class="nav-link" href="copyright.php">Copy Right</a>
                        </nav>
                    </div>

                    <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#categoryOption" aria-expanded="false" aria-controls="categoryOption">
                        <div class="sb-nav-link-icon"><i class="fas fa-columns"></i></div>
                        Category Options
                        <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                    </a>
                    <div class="collapse" id="categoryOption" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                        <nav class="sb-sidenav-menu-nested nav">
